...
const corsOptions = {
  ...
  origin: ["https://nsc-encryption-decryption.web.app"],
  credentials: true,
...
// ---------------------------------------------------------------------------------------------
app.get("/", (req, res) => {
  res.send("Encryption Decryption Server is Alive.............");
});

app.listen(port, () => {
  console.log(`Encryption Decryption Server is running on port ${port}`);
});
